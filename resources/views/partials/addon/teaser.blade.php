...
<div class="bg-gray-100 transition-all leading-normal p-8 rounded-md transform hover:-translate-y-2 hover:shadow-md">
    <a href="{{ $entry->augmentedValue('link') }}" target="_blank" rel="noopener" class="flex flex-col h-full no-shadow block text-gray-700 no-underline mb-4 hover:text-gray-900">
