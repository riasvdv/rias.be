...
contents:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'This isn''t as concise or pretty as the Antlers version, but it works. What I have done in our projects is added a helper function to our project that wraps this up nicely:'
  -
    type: set
    attrs:
      values:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'What I''ve been using is the following helper, which takes a string of the tag you want to render, combined with a set of parameters, which allows you to create the same blog listing above in Blade:'
  -
    type: set
    attrs:
      values:
