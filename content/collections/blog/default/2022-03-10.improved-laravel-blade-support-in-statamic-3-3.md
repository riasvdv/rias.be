...
contents:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' value will be wrapped in a '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' helper that allows you to fetch the content of any tag in Statamic. This has been added to the core as well, which means you no longer need custom code for this!'
  -
    type: set
    attrs:
      values:
