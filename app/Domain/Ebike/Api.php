...
class Api
{
    public function getActivityHeaders()
    {
        return Http::withCookies([
            ...
            ->get('https://www.ebike-connect.com/ebikeconnect/api/portal/activities/trip/headers?max=20&offset=1635405048712')
            ->json() ?? [];
    }

    public function syncRideToStrava(string $rideId): bool
    {
        return Http::withCookies([
                'REMEMBER' => config('services.ebike.remember'),
                'JSESSIONID' => config('services.ebike.session_id'),
